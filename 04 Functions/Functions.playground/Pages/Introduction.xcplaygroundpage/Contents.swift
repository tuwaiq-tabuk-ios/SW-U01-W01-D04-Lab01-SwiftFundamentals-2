/*:
 ...
 The idea of taking something complex and defining a simpler way to refer to it is called *abstraction*. Abstraction is a fundamental idea in software development. It’s how programmers keep from getting overwhelmed by details and complexity.
 
 In this lesson you’ll learn how to define and use _functions_, one of the most fundamental ways to define abstraction in code.
