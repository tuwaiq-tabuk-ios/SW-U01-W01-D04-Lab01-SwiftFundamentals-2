/*:
 ...
 - experiment: With all of these changes, how likely is it that everyone is going to end up at the right place at the right time?\
\
Would mistakes be less likely if the plan didn't change?
 ...
 Sometimes you do need to use variables. Things do change in a program as it runs. In programming, something that is able to change is called _mutable_, based on the word _mutate_, which just means “to change”.
 
 Something that is unable to be changed is called _immutable_. As a rule of thumb, if something doesn't need to change, always use a constant to reduce the chance of confusion and errors.
...
var meettingplace = "The movies"
meettingplace = "friend’s house"
meettingplace = "other friend’s house"
...
let answor = "All friend will metting time \(meettingTime) in \(meettingplace)"
